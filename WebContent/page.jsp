...
<script type="text/javascript" src="Recursos/JavaScript/script.js"></script>
</head>
<body>
					...
					<div class="art-nav">
						...
						<div class="art-nav-center">
							<ul class="art-menu">
								...
								<li><a class="active" href="#"><span class="l"></span><span
										class="r"></span><span class="t">¿Quienes somos?</span></a>
									<ul>
										<li><a href="#">Misión</a></li>
										<li><a href="#">Visión</a></li>
										<li><a href="#">Compromisos</a></li>
										<li><a href="#">Valores</a></li>
										<li><a href="#">Organigráma</a></li>
										<li><a href="#">Contactanos</a></li>
									</ul></li>
								<li><a href="#"><span class="l"></span><span class="r"></span><span
										class="t">Categorías</span></a>
									<ul>
										<li><a href="#">Preparatorio Nivel I</a></li>
										<li><a href="#">Preparatorio Nivel II</a></li>
										<li><a href="#">PreInfantil</a></li>
								...
								<li=""><a href="#"><span class="l"></span><span
										class="r"></span><span class="t">¿Que necesito?</span></a>
									<ul>
							...
							<div class="art-layout-cell art-sidebar1">
								...
								<div class="art-block">
									<div class="art-block-body">
										...
										<img src="Recursos/Imagenes/grafico.jpg"> <br> <br>
										<div class="art-blockheader">
											<div class="l"></div>
											<div class="r"></div>
											...
											<div class="art-blockcontent-body">
												<form name="form2" method="post" action="index.php">
													<table class="poll" align="center" border="0"
														...
														<thead>
															<tr>
																<td style="font-weight: bold;">¿En que categoria
																	desea inscribir a su hijo?</td>
															</tr>
														</thead>
														<tbody>
															<tr>
																		...
																		<tbody>
																			<tr>
																				<td class="sectiontableentry2" valign="top"><input
																					alt="1" value="1" id="voteid1" name="voteid"
																					type="radio"></td>
																				<td class="sectiontableentry2" valign="top"><label
																					for="voteid1">Preparatorio Niv I</label></td>
																			</tr>
																			<tr>
																				<td class="sectiontableentry1" valign="top"><input
																					alt="2" value="2" id="voteid2" name="voteid"
																					type="radio"></td>
																				<td class="sectiontableentry1" valign="top"><label
																					for="voteid2">Preparatorio Niv II</label></td>
																			</tr>
																			<tr>
																				<td class="sectiontableentry2" valign="top"><input
																					alt="3" value="3" id="voteid3" name="voteid"
																					type="radio"></td>
																				<td class="sectiontableentry2" valign="top"><label
																					for="voteid3">PreInfantil</label></td>
																			</tr>
																			<tr>
																				<td class="sectiontableentry1" valign="top"><input
																					alt="4" value="4" id="voteid4" name="voteid"
																					type="radio"></td>
																				<td class="sectiontableentry1" valign="top"><label
																					for="voteid4">Infantil</label></td>
																			</tr>
																			<tr>
																				<td class="sectiontableentry2" valign="top"><input
																					alt="5" value="5" id="voteid5" name="voteid"
																					type="radio"></td>
																				<td class="sectiontableentry2" valign="top"><label
																					for="voteid5">PreJunior</label></td>
																			</tr>
																			<tr>
																				<td class="sectiontableentry1" valign="top"><input
																					alt="6" value="6" id="voteid6" name="voteid"
																					type="radio"></td>
																				<td class="sectiontableentry1" valign="top"><label
																					for="voteid6">Junior</label></td>
																			</tr>
																			<tr>
																				<td class="sectiontableentry2" valign="top"><input
																					alt="7" value="7" id="voteid7" name="voteid"
																					type="radio"></td>
																				<td class="sectiontableentry2" valign="top"><label
																					for="voteid7">Juvenil</label></td>
																			</tr>
																		</tbody>
																	</table>
																</td>
																...
																<td>
																	<div align="center">
																		<span class="art-button-wrapper"> <span
																			...
																			class="art-button-r"> </span> <input value="Votar"
																			class="art-button" name="task_button" type="submit"></span>&nbsp;
																		<span class="art-button-wrapper"> <span
																			class="art-button-l"> </span> <span
																			class="art-button-r"> </span> <input
																			value="Resultados" class="art-button" name="option"
																			type="button"></span>
																	</div>
																</td>
															</tr>
										...
										<div class="art-post-inner art-article">
											...
											<div class="art-postheadericons art-metadata-icons">
												<img src="Recursos/Imagenes/postdateicon.png" alt=""
													height="18" width="17"> 26 de Octubre de 2011 | <img
											...
											<div class="art-postcontent">
												...
												<p>En horas de la mañana de ayer, en compania de
													...
													y Prevencion del Delito, con participacion de diez escuelas
													beisboleras.
												<p>
													<span class="art-button-wrapper"> <span
												...
												<br>
												<br>
												<br> <img src="Recursos/Imagenes/publicidad.png"><br>
												<br>
												</p>
											</div>
											<div class="cleared"></div>
												...
												<form id="form-login" name="login" method="post" action="#">
													<fieldset class="input">
														<p id="form-login-username">
															<label for="modlgn_username">Usuario</label><br> <input
																size="18" alt="username" class="inputbox"
																name="username" id="modlgn_username" type="text">
														</p>
														<p id="form-login-password">
															<label for="modlgn_passwd">Contraseña</label><br> <input
																alt="password" size="18" class="inputbox" name="passwd"
																id="modlgn_passwd" type="password">
														</p>
														<p id="form-login-remember">
															<label for="modlgn_remember">Recuerdame</label> <input
																alt="Remember Me" value="yes" class="inputbox"
																name="remember" id="modlgn_remember" type="checkbox">
														</p>
														<span class="art-button-wrapper"> <span
															class="art-button-l"> </span> <span class="art-button-r">
										...
										<div class="art-blockheader">
											...
											<div class="art-blockcontent-body">
												<div class="bannergroup_text">
													<img src="Recursos/Imagenes/noticias.png"><br>
													<br> <img src="Recursos/Imagenes/iconos.png"><br>
													<br> <img src="Recursos/Imagenes/redes.png">
