...
/**
 * The persistent class for the empleado_concepto_nomina database table.
 * 
 */
@Entity
@Table(name="empleado_concepto_nomina")
public class EmpleadoConceptoNomina implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private EmpleadoConceptoNominaPK id;
    ...
    @ManyToOne
	@JoinColumn(name="codigo_concepto_nomina")
	...
	public EmpleadoConceptoNominaPK getId() {
		return this.id;
	}

	public void setId(EmpleadoConceptoNominaPK id) {
		this.id = id;
	}
