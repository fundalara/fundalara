...
CREATE SEQUENCE public.dato_basico_codigo_dato_basico_seq_2_5_1;

CREATE TABLE public.dato_basico (
                codigo_dato_basico INTEGER NOT NULL DEFAULT nextval('public.dato_basico_codigo_dato_basico_seq_2_5_1'),
...
ALTER SEQUENCE public.dato_basico_codigo_dato_basico_seq_2_5_1 OWNED BY public.dato_basico.codigo_dato_basico;
...
CREATE TABLE public.clasificacion_competencia (
                ...
                descripcion VARCHAR,
                estatus CHAR NOT NULL,
                CONSTRAINT clasificacion_competencia_pk PRIMARY KEY (codigo_clasificacion_competencia)
);


CREATE TABLE public.condicion_competencia (
                codigo_condicion_competencia INTEGER NOT NULL,
                codigo_clasificacion_competencia INTEGER NOT NULL,
                codigo_condicion INTEGER NOT NULL,
                CONSTRAINT condicion_competencia_pk PRIMARY KEY (codigo_condicion_competencia)
);
...
CREATE TABLE public.tipo_ingreso (
                ...
                estatus CHAR NOT NULL,
                aplica_representante BOOLEAN NOT NULL,
...
CREATE TABLE public.ingreso_inscripcion (
                codigo_tipo_ingreso INTEGER NOT NULL,
                codigo_inscripcion INTEGER NOT NULL,
                cantidad INTEGER NOT NULL,
                adelantos INTEGER NOT NULL,
                monto DOUBLE PRECISION NOT NULL,
                estatus CHAR NOT NULL,
                CONSTRAINT ingreso_inscripcion_pk PRIMARY KEY (codigo_tipo_ingreso, codigo_inscripcion)
);
...
CREATE TABLE public.lapso_deportivo (
                ...
                nombre VARCHAR NOT NULL,
                estatus CHAR NOT NULL,
                fecha_inicio_ascenso DATE,
                fecha_fin_ascenso DATE,
...
CREATE TABLE public.ingreso (
                codigo_ingreso INTEGER NOT NULL,
                numero_documento VARCHAR,
                fecha_pago DATE NOT NULL,
                estatus CHAR NOT NULL,
...
CREATE TABLE public.ingreso_forma_pago (
                ...
                CONSTRAINT ingreso_forma_pago_pk PRIMARY KEY (codigo_ingreso_forma_pago, codigo_ingreso)
);
...
CREATE TABLE public.ingreso_documento_acreedor (
                ...
                estatus CHAR NOT NULL,
                CONSTRAINT ingreso_documento_acreedor_pk PRIMARY KEY (codigo_documento_acreedor, codigo_ingreso)
);
...
CREATE TABLE public.detalle_requisicion (
                codigo_detalle_requisicion INTEGER NOT NULL,
                codigo_material INTEGER NOT NULL,
                codigo_requisicion INTEGER NOT NULL,
                cantidad_solicitada INTEGER NOT NULL,
                cantidad_entregada INTEGER,
                estatus CHAR NOT NULL,
                CONSTRAINT detalle_requisicion_pk PRIMARY KEY (codigo_detalle_requisicion)
);
...
CREATE SEQUENCE public.actividad_entrenamiento_codigo_actividad_entrenamiento_seq;

CREATE TABLE public.actividad_entrenamiento (
                codigo_actividad_entrenamiento INTEGER NOT NULL DEFAULT nextval('public.actividad_entrenamiento_codigo_actividad_entrenamiento_seq'),
                fase INTEGER NOT NULL,
                codigo_categoria INTEGER NOT NULL,
                nombre VARCHAR NOT NULL,
                estatus CHAR NOT NULL,
                CONSTRAINT actividad_entrenamiento_pk PRIMARY KEY (codigo_actividad_entrenamiento)
);


ALTER SEQUENCE public.actividad_entrenamiento_codigo_actividad_entrenamiento_seq OWNED BY public.actividad_entrenamiento.codigo_actividad_entrenamiento;
...
CREATE TABLE public.indicador_actividad_escala (
                ...
                codigo_escala INTEGER NOT NULL,
                codigo_actividad_entrenamiento INTEGER NOT NULL,
                estatus CHAR NOT NULL,
...
CREATE TABLE public.comision_actividad_planificada (
                codigo_comision_actividad_plan INTEGER NOT NULL,
                codigo_planificacion_actividad INTEGER NOT NULL,
                codigo_comision INTEGER NOT NULL,
                CONSTRAINT comision_actividad_planificada_pk PRIMARY KEY (codigo_comision_actividad_plan)
);
...
CREATE TABLE public.personal_actividad (
                codigo_personal_actividad INTEGER NOT NULL,
                codigo_actividad INTEGER NOT NULL,
                cedula_rif VARCHAR NOT NULL,
                estatus CHAR NOT NULL,
                CONSTRAINT personal_actividad_pk PRIMARY KEY (codigo_personal_actividad)
);


CREATE TABLE public.comision_actividad (
                codigo_comision_actividad INTEGER NOT NULL,
                codigo_actividad INTEGER NOT NULL,
                codigo_comision INTEGER NOT NULL,
                CONSTRAINT comision_actividad_pk PRIMARY KEY (codigo_comision_actividad)
);


CREATE SEQUENCE public.tarea_actividad_codigo_tarea_actividad_seq;

CREATE SEQUENCE public.personal_actividad_seq;
...
CREATE TABLE public.tarea_actividad (
                ...
                codigo_personal_actividad INTEGER NOT NULL DEFAULT nextval('public.personal_actividad_seq'),
                codigo_actividad INTEGER NOT NULL,
                codigo_tarea INTEGER NOT NULL,
                estatus CHAR NOT NULL,
                tarea_ejecutada BOOLEAN NOT NULL,
...
ALTER SEQUENCE public.personal_actividad_seq OWNED BY public.tarea_actividad.codigo_personal_actividad;

CREATE TABLE public.estado_actividad (
                codigo_estado_actividad INTEGER NOT NULL,
                codigo_actividad INTEGER NOT NULL,
                codigo_estado INTEGER NOT NULL,
                estatus CHAR NOT NULL,
                CONSTRAINT estado_actividad_pk PRIMARY KEY (codigo_estado_actividad)
);
...
CREATE TABLE public.solicitud_mantenimiento (
                ...
                CONSTRAINT solicitud_mantenimiento_pk PRIMARY KEY (codigo_solicitud)
);
...
CREATE TABLE public.personal_actividad_planificada (
                codigo_personal_actividad_plan INTEGER NOT NULL,
                cedula_rif VARCHAR NOT NULL,
                codigo_planificacion_actividad INTEGER NOT NULL,
                estatus CHAR NOT NULL,
                CONSTRAINT personal_actividad_planificada_pk PRIMARY KEY (codigo_personal_actividad_plan)
);
...
CREATE TABLE public.sesion_ejecutada (
                ...
                codigo_sesion INTEGER NOT NULL,
                eventualidad_sesion INTEGER,
                codigo_equipo INTEGER NOT NULL,
                fecha DATE NOT NULL,
                hora_fin TIME NOT NULL,
                estatus CHAR NOT NULL,
                hora_inicio TIME NOT NULL,
                observacion_sesion VARCHAR,
                CONSTRAINT sesion_ejecutada_pk PRIMARY KEY (codigo_sesion_ejecutada)
);


CREATE TABLE public.instalacion_ejecutada (
                codigo_instalacion_ejecutada INTEGER NOT NULL,
                codigo_sesion_ejecutada INTEGER NOT NULL,
                codigo_instalacion INTEGER,
                codigo_instalacion_utilizada INTEGER NOT NULL,
                eventualidad_instalacion INTEGER,
                observacion VARCHAR,
                estatus CHAR NOT NULL,
                CONSTRAINT instalacion_ejecutada_pk PRIMARY KEY (codigo_instalacion_ejecutada)
);
...
CREATE TABLE public.actividad_planificada (
                ...
                tiempo INTEGER NOT NULL,
                estatus CHAR NOT NULL,
                CONSTRAINT actividad_planificada_pk PRIMARY KEY (codigo_sesion, codigo_actividad_entrenamiento)
);
...
CREATE TABLE public.personal_equipo_competencia (
                codigo_personal_equipo INTEGER NOT NULL,
                codigo_competencia INTEGER NOT NULL,
                estatus CHAR NOT NULL,
                CONSTRAINT personal_equipo_competencia_pk PRIMARY KEY (codigo_personal_equipo, codigo_competencia)
);
...
CREATE SEQUENCE public.comision_familiar_codigo_comision_familiar_seq;

CREATE TABLE public.comision_familiar (
                codigo_comision_familiar INTEGER NOT NULL DEFAULT nextval('public.comision_familiar_codigo_comision_familiar_seq'),
                codigo_familiar_jugador INTEGER NOT NULL,
                codigo_comision INTEGER NOT NULL,
                estatus_1 CHAR NOT NULL,
                CONSTRAINT comision_familiar_pk PRIMARY KEY (codigo_comision_familiar)
);


ALTER SEQUENCE public.comision_familiar_codigo_comision_familiar_seq OWNED BY public.comision_familiar.codigo_comision_familiar;

CREATE SEQUENCE public.tarea_actividad_planificada_codigo_tarea_actividad_planifica793;

CREATE TABLE public.tarea_actividad_planificada (
                codigo_tarea_actividad_planificada INTEGER NOT NULL DEFAULT nextval('public.tarea_actividad_planificada_codigo_tarea_actividad_planifica793'),
                codigo_comision_familiar INTEGER,
                codigo_personal_actividad_plan INTEGER,
                codigo_planificacion_actividad INTEGER NOT NULL,
                codigo_tarea INTEGER NOT NULL,
                estatus CHAR NOT NULL,
                tarea_ejecutada BOOLEAN NOT NULL,
                CONSTRAINT tarea_actividad_planificada_pk PRIMARY KEY (codigo_tarea_actividad_planificada)
);


ALTER SEQUENCE public.tarea_actividad_planificada_codigo_tarea_actividad_planifica793 OWNED BY public.tarea_actividad_planificada.codigo_tarea_actividad_planificada;
...
CREATE TABLE public.jugador_foraneo_roster_competencia (
                codigo_jugador_foraneo_roster_competencia INTEGER NOT NULL,
                cedula VARCHAR NOT NULL,
                codigo_roster_competencia INTEGER NOT NULL,
                CONSTRAINT jugador_foraneo_roster_competencia_pk PRIMARY KEY (codigo_jugador_foraneo_roster_competencia)
);
...
CREATE TABLE public.desempenno_jugador (
                codigo_desempenno_jugador INTEGER NOT NULL,
                codigo_actividad_ejecutada INTEGER NOT NULL,
                codigo_asistencia INTEGER NOT NULL,
                estatus CHAR NOT NULL,
                CONSTRAINT desempenno_jugador_pk PRIMARY KEY (codigo_desempenno_jugador)
);


CREATE TABLE public.puntuacion_jugador (
                codigo_desempenno_jugador INTEGER NOT NULL,
                codigo_indicador_actividad_escala INTEGER NOT NULL,
                puntuacion VARCHAR NOT NULL,
                estatus CHAR NOT NULL,
                CONSTRAINT puntuacion_jugador_pk PRIMARY KEY (codigo_desempenno_jugador, codigo_indicador_actividad_escala)
);
...
ALTER TABLE public.comision_familiar ADD CONSTRAINT dato_basico_comision_equipo_fk
...
ALTER TABLE public.tipo_ingreso ADD CONSTRAINT dato_basico_tipo_ingreso_fk1
FOREIGN KEY (codigo_tipo)
REFERENCES public.dato_basico (codigo_dato_basico)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.comision_actividad_planificada ADD CONSTRAINT dato_basico_comision_actividad_planificada_fk
FOREIGN KEY (codigo_comision)
REFERENCES public.dato_basico (codigo_dato_basico)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.ingreso_inscripcion ADD CONSTRAINT dato_basico_ingreso_inscripcion_fk
FOREIGN KEY (codigo_inscripcion)
REFERENCES public.dato_basico (codigo_dato_basico)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE public.tarea_actividad ADD CONSTRAINT dato_basico_tarea_actividad_fk
FOREIGN KEY (codigo_dato_basico)
REFERENCES public.dato_basico (codigo_dato_basico)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
ALTER TABLE public.ingreso_inscripcion ADD CONSTRAINT tipo_ingreso_ingreso_inscripcion_fk
FOREIGN KEY (codigo_tipo_ingreso)
REFERENCES public.tipo_ingreso (codigo_tipo_ingreso)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
REFERENCES public.ingreso (codigo_ingreso)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE public.ingreso_forma_pago ADD CONSTRAINT ingreso_ingreso_forma_pago_fk
FOREIGN KEY (codigo_ingreso)
REFERENCES public.ingreso (codigo_ingreso)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.planificacion_actividad ADD CONSTRAINT personal_planificacion_actividad_fk
FOREIGN KEY (cedula_rif)
REFERENCES public.personal (cedula_rif)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.personal_actividad_planificada ADD CONSTRAINT personal_personal_actividad_planificada_fk
FOREIGN KEY (cedula_rif)
REFERENCES public.personal (cedula_rif)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.personal_equipo_competencia ADD CONSTRAINT competencia_personal_equipo_competencia_fk
FOREIGN KEY (codigo_competencia)
REFERENCES public.competencia (codigo_competencia)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.instalacion_ejecutada ADD CONSTRAINT instalacion_instalacion_ejecutada_fk
FOREIGN KEY (codigo_instalacion)
REFERENCES public.instalacion (codigo_instalacion)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
FOREIGN KEY (codigo_actividad_entrenamiento)
REFERENCES public.actividad_entrenamiento (codigo_actividad_entrenamiento)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE public.actividades_ejecutadas ADD CONSTRAINT actividad_entrenamiento_actividades_ejecutadas_fk
FOREIGN KEY (codigo_actividad_entrenamiento)
REFERENCES public.actividad_entrenamiento (codigo_actividad_entrenamiento)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.actividad_planificada ADD CONSTRAINT actividad_entrenamiento_actividad_planificada_fk
FOREIGN KEY (codigo_actividad_entrenamiento)
REFERENCES public.actividad_entrenamiento (codigo_actividad_entrenamiento)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.puntuacion_jugador ADD CONSTRAINT indicador_actividad_escala_puntuacion_jugador_fk
FOREIGN KEY (codigo_indicador_actividad_escala)
REFERENCES public.indicador_actividad_escala (codigo_indicador_actividad_escala)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.roster_competencia ADD CONSTRAINT equipo_roster_competencia_fk
FOREIGN KEY (codigo_equipo)
REFERENCES public.equipo (codigo_equipo)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.comision_actividad_planificada ADD CONSTRAINT planificacion_actividad_comision_actividad_planificada_fk
FOREIGN KEY (codigo_planificacion_actividad)
REFERENCES public.planificacion_actividad (codigo_planificacion_actividad)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
FOREIGN KEY (codigo_personal_actividad)
REFERENCES public.personal_actividad (codigo_personal_actividad)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
FOREIGN KEY (codigo_personal_actividad_plan)
REFERENCES public.personal_actividad_planificada (codigo_personal_actividad_plan)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
ALTER TABLE public.personal_equipo_competencia ADD CONSTRAINT personal_equipo_personal_equipo_competencia_fk
FOREIGN KEY (codigo_personal_equipo)
REFERENCES public.personal_equipo (codigo_personal_equipo)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.comision_familiar ADD CONSTRAINT familiar_jugador_comision_familiar_fk
FOREIGN KEY (codigo_familiar_jugador)
REFERENCES public.familiar_jugador (codigo_familiar_jugador)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE public.tarea_actividad_planificada ADD CONSTRAINT comision_familiar_tarea_actividad_planificada_fk
FOREIGN KEY (codigo_comision_familiar)
REFERENCES public.comision_familiar (codigo_comision_familiar)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
ALTER TABLE public.puntuacion_jugador ADD CONSTRAINT desempenno_jugador_puntuacion_jugador_fk
FOREIGN KEY (codigo_desempenno_jugador)
REFERENCES public.desempenno_jugador (codigo_desempenno_jugador)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
