...
public class DaoIndicadorCategoriaCompetencia extends GenericDao {
	...
	public List<IndicadorCategoriaCompetencia> listarCompetenciaIndicador(
		...
		Transaction tx = session.beginTransaction();
		Criteria c = session
				.createCriteria(IndicadorCategoriaCompetencia.class);
	...
	public IndicadorCategoriaCompetencia obtenerIndicadorCarrera() {
		...
		Criteria c = session
				.createCriteria(IndicadorCategoriaCompetencia.class);
		Criteria c2 = c.createCriteria("indicador");
		c2.add(Restrictions.eq("abreviatura", "C"));
		return (IndicadorCategoriaCompetencia) c.uniqueResult();
