 ...
 */
@Entity
@Table(name="personal_foraneo_juego"
    ,schema="public"
)
public class PersonalForaneoJuego  implements java.io.Serializable {
    ...
    public PersonalForaneoJuego(PersonalForaneoJuegoId id, Juego juego, PersonalForaneo personalForaneo) {
        this.id = id;
        this.juego = juego;
        this.personalForaneo = personalForaneo;
    }
    public PersonalForaneoJuego(PersonalForaneoJuegoId id, DatoBasico datoBasico, Juego juego, PersonalForaneo personalForaneo) {
       this.id = id;
