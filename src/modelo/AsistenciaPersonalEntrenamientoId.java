...
public class AsistenciaPersonalEntrenamientoId  implements java.io.Serializable {
    ...
    public AsistenciaPersonalEntrenamientoId(int codigoSesionEjecutada, int codigoPersonalEquipo) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AsistenciaPersonalEntrenamientoId) ) return false;
		 AsistenciaPersonalEntrenamientoId castOther = ( AsistenciaPersonalEntrenamientoId ) other; 
         
		 return (this.getCodigoSesionEjecutada()==castOther.getCodigoSesionEjecutada())
 && (this.getCodigoPersonalEquipo()==castOther.getCodigoPersonalEquipo());
   }
