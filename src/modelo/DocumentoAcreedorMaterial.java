 ...
 */
@Entity
@Table(name="documento_acreedor_material"
    ,schema="public"
)
public class DocumentoAcreedorMaterial  implements java.io.Serializable {
    ...
    public DocumentoAcreedorMaterial(DocumentoAcreedorMaterialId id, DocumentoAcreedor documentoAcreedor, Material material, char estatus, int cantidad) {
       this.id = id;
