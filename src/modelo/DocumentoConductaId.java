...
public class DocumentoConductaId  implements java.io.Serializable {
    ...
    public DocumentoConductaId(int codigoDocumentoEntregado, int codigoDatoConducta) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DocumentoConductaId) ) return false;
 ...
 && (this.getCodigoDatoConducta()==castOther.getCodigoDatoConducta());
   }
