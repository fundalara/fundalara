...
public class ResultadoActividad  implements java.io.Serializable {
    ...
    public ResultadoActividad(ResultadoActividadId id, DatoBasico datoBasico, Actividad actividad, char estatus) {
        this.id = id;
        this.datoBasico = datoBasico;
        this.actividad = actividad;
        this.estatus = estatus;
    }
    public ResultadoActividad(ResultadoActividadId id, DatoBasico datoBasico, Actividad actividad, String observaciones, char estatus) {
       this.id = id;
       this.datoBasico = datoBasico;
       this.actividad = actividad;
