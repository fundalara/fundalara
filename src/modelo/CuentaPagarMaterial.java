 ...
 */
@Entity
@Table(name="cuenta_pagar_material"
    ,schema="public"
)
public class CuentaPagarMaterial  implements java.io.Serializable {
    ...
    public CuentaPagarMaterial(CuentaPagarMaterialId id, Material material, CuentaPagar cuentaPagar, int cantidad, double precioUnitario, char estatus) {
       this.id = id;
