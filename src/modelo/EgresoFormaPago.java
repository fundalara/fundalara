...
public class EgresoFormaPago  implements java.io.Serializable {
    ...
    public EgresoFormaPago(EgresoFormaPagoId id, Egreso egreso, double monto, char estatus) {
        this.id = id;
        this.egreso = egreso;
        this.monto = monto;
        this.estatus = estatus;
    }
    public EgresoFormaPago(EgresoFormaPagoId id, Egreso egreso, DatoBasico datoBasicoByCodigoFormaPago, DatoBasico datoBasicoByCodigoBanco, DatoBasico datoBasicoByCodigoTarjeta, double monto, char estatus, String numeroDocuemntoPago) {
       this.id = id;
       this.egreso = egreso;
