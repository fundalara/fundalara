 ...
 */
@Entity
@Table(name="ingreso_documento_acreedor"
    ,schema="public"
)
public class IngresoDocumentoAcreedor  implements java.io.Serializable {
    ...
    public IngresoDocumentoAcreedor(IngresoDocumentoAcreedorId id, DocumentoAcreedor documentoAcreedor, Ingreso ingreso, double montoAbonado, char estatus) {
       this.id = id;
