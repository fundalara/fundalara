...
public class DocumentoPersonalId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DocumentoPersonalId) ) return false;
		 DocumentoPersonalId castOther = ( DocumentoPersonalId ) other; 
         
		 return (this.getCodigoDocumentoEntregado()==castOther.getCodigoDocumentoEntregado())
 && ( (this.getCedulaRif()==castOther.getCedulaRif()) || ( this.getCedulaRif()!=null && castOther.getCedulaRif()!=null && this.getCedulaRif().equals(castOther.getCedulaRif()) ) );
   }
