...
public class CategoriaCompetencia  implements java.io.Serializable {
    ...
    public CategoriaCompetencia(CategoriaCompetenciaId id, Categoria categoria, Competencia competencia, char estatus) {
        this.id = id;
        this.categoria = categoria;
        this.competencia = competencia;
        this.estatus = estatus;
    }
    public CategoriaCompetencia(CategoriaCompetenciaId id, Categoria categoria, Competencia competencia, Date duracionHora, Integer duracionInning, char estatus) {
       this.id = id;
       this.categoria = categoria;
       this.competencia = competencia;
