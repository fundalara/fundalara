...
public class RepresentanteJugadorPlanId  implements java.io.Serializable {
    ...
    public RepresentanteJugadorPlanId(String cedulaJugador, String cedulaFamiliar) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof RepresentanteJugadorPlanId) ) return false;
		 RepresentanteJugadorPlanId castOther = ( RepresentanteJugadorPlanId ) other; 
         
		 return ( (this.getCedulaJugador()==castOther.getCedulaJugador()) || ( this.getCedulaJugador()!=null && castOther.getCedulaJugador()!=null && this.getCedulaJugador().equals(castOther.getCedulaJugador()) ) )
 && ( (this.getCedulaFamiliar()==castOther.getCedulaFamiliar()) || ( this.getCedulaFamiliar()!=null && castOther.getCedulaFamiliar()!=null && this.getCedulaFamiliar().equals(castOther.getCedulaFamiliar()) ) );
   }
   
   public int hashCode() {
         int result = 17;
         
         result = 37 * result + ( getCedulaJugador() == null ? 0 : this.getCedulaJugador().hashCode() );
         result = 37 * result + ( getCedulaFamiliar() == null ? 0 : this.getCedulaFamiliar().hashCode() );
         return result;
   }   
