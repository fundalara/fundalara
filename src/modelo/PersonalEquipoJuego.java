 ...
 */
@Entity
@Table(name="personal_equipo_juego"
    ,schema="public"
)
public class PersonalEquipoJuego  implements java.io.Serializable {
    ...
    public PersonalEquipoJuego(PersonalEquipoJuegoId id, PersonalEquipoCompetencia personalEquipoCompetencia, EquipoJuego equipoJuego, char estatus) {
       this.id = id;
...
@ManyToOne(fetch=FetchType.LAZY)
    ...
    public void setPersonalEquipoCompetencia(PersonalEquipoCompetencia personalEquipoCompetencia) {
        this.personalEquipoCompetencia = personalEquipoCompetencia;
    }
