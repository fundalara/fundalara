...
public class ActividadPlanificadaId  implements java.io.Serializable {
    ...
    public ActividadPlanificadaId(int codigoSesion, int codigoActividadEntrenamiento) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ActividadPlanificadaId) ) return false;
		 ActividadPlanificadaId castOther = ( ActividadPlanificadaId ) other; 
         
		 return (this.getCodigoSesion()==castOther.getCodigoSesion())
 && (this.getCodigoActividadEntrenamiento()==castOther.getCodigoActividadEntrenamiento());
   }
