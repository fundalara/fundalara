...
public class LogroPorJugador  implements java.io.Serializable {
    ...
    public LogroPorJugador(LogroPorJugadorId id, DatoDeportivo datoDeportivo, DatoBasico datoBasico, char estatus) {
        this.id = id;
        this.datoDeportivo = datoDeportivo;
        this.datoBasico = datoBasico;
        this.estatus = estatus;
    }
    public LogroPorJugador(LogroPorJugadorId id, DatoDeportivo datoDeportivo, DatoBasico datoBasico, String observacion, char estatus) {
       this.id = id;
       this.datoDeportivo = datoDeportivo;
       this.datoBasico = datoBasico;
