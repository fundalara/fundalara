...
public class PuntuacionJugador  implements java.io.Serializable {
    ...
    public PuntuacionJugador(PuntuacionJugadorId id, DesempennoJugador desempennoJugador, IndicadorActividadEscala indicadorActividadEscala, String puntuacion, char estatus) {
       this.id = id;
