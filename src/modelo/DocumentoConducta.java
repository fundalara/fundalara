...
public class DocumentoConducta  implements java.io.Serializable {
    ...
    public DocumentoConducta(DocumentoConductaId id, DocumentoEntregado documentoEntregado, DatoConducta datoConducta, char estatus) {
       this.id = id;
