...
public class RecepcionMaterial  implements java.io.Serializable {
    ...
    public RecepcionMaterial(RecepcionMaterialId id, Material material, NotaEntrega notaEntrega, int cantidadRecibida, char estatus) {
        this.id = id;
    ...
    public RecepcionMaterial(RecepcionMaterialId id, Material material, NotaEntrega notaEntrega, int cantidadRecibida, String observaciones, char estatus) {
       this.id = id;
       this.material = material;
       this.notaEntrega = notaEntrega;
       this.cantidadRecibida = cantidadRecibida;
