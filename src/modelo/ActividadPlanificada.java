 ...
 */
@Entity
@Table(name="actividad_planificada"
    ,schema="public"
)
public class ActividadPlanificada  implements java.io.Serializable {
    ...
    public ActividadPlanificada(ActividadPlanificadaId id, ActividadEntrenamiento actividadEntrenamiento, Sesion sesion, int tiempo, char estatus) {
       this.id = id;
