 ...
 */
@Entity
@Table(name="asistencia_personal_entrenamiento"
    ,schema="public"
)
public class AsistenciaPersonalEntrenamiento  implements java.io.Serializable {
    ...
    public AsistenciaPersonalEntrenamiento(AsistenciaPersonalEntrenamientoId id, SesionEjecutada sesionEjecutada, PersonalEquipo personalEquipo, boolean asistencia, char estatus) {
        this.id = id;
    ...
    public AsistenciaPersonalEntrenamiento(AsistenciaPersonalEntrenamientoId id, SesionEjecutada sesionEjecutada, PersonalEquipo personalEquipo, DatoBasico datoBasico, boolean asistencia, String observacion, char estatus) {
       this.id = id;
       this.sesionEjecutada = sesionEjecutada;
       this.personalEquipo = personalEquipo;
