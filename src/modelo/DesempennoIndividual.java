 ...
 */
@Entity
@Table(name="desempenno_individual"
    ,schema="public"
)
public class DesempennoIndividual  implements java.io.Serializable {
    ...
    public DesempennoIndividual(DesempennoIndividualId id, IndicadorCategoriaCompetencia indicadorCategoriaCompetencia, LineUp lineUp, float valor) {
       this.id = id;
