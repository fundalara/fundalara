 ...
 */
@Entity
@Table(name="ingreso_inscripcion"
    ,schema="public"
)
public class IngresoInscripcion  implements java.io.Serializable {
    ...
    public IngresoInscripcion(IngresoInscripcionId id, TipoIngreso tipoIngreso, DatoBasico datoBasico, int cantidad, int adelantos, char estatus) {
       this.id = id;
