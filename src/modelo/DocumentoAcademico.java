 ...
 */
@Entity
@Table(name="documento_academico"
    ,schema="public"
)
public class DocumentoAcademico  implements java.io.Serializable {
    ...
    public DocumentoAcademico(DocumentoAcademicoId id, DocumentoEntregado documentoEntregado, DatoAcademico datoAcademico, char estatus) {
       this.id = id;
