...
public class DocumentoIndumentariaId  implements java.io.Serializable {
    ...
    public DocumentoIndumentariaId(int codigoDocumentoAcreedor, int codigoTallaIndumentaria) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DocumentoIndumentariaId) ) return false;
		 DocumentoIndumentariaId castOther = ( DocumentoIndumentariaId ) other; 
         
		 return (this.getCodigoDocumentoAcreedor()==castOther.getCodigoDocumentoAcreedor())
 && (this.getCodigoTallaIndumentaria()==castOther.getCodigoTallaIndumentaria());
   }
