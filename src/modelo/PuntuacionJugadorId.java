...
public class PuntuacionJugadorId  implements java.io.Serializable {
    ...
    public PuntuacionJugadorId(int codigoDesempennoJugador, int codigoIndicadorActividadEscala) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PuntuacionJugadorId) ) return false;
		 PuntuacionJugadorId castOther = ( PuntuacionJugadorId ) other; 
         
		 return (this.getCodigoDesempennoJugador()==castOther.getCodigoDesempennoJugador())
 && (this.getCodigoIndicadorActividadEscala()==castOther.getCodigoIndicadorActividadEscala());
   }
