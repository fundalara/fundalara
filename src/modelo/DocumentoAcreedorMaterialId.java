...
public class DocumentoAcreedorMaterialId  implements java.io.Serializable {
    ...
    public DocumentoAcreedorMaterialId(int codigoMaterial, int codigoDocumentoAcreedor) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DocumentoAcreedorMaterialId) ) return false;
 ...
 && (this.getCodigoDocumentoAcreedor()==castOther.getCodigoDocumentoAcreedor());
   }
