 ...
 */
@Entity
@Table(name="documento_indumentaria"
    ,schema="public"
)
public class DocumentoIndumentaria  implements java.io.Serializable {
    ...
    public DocumentoIndumentaria(DocumentoIndumentariaId id, TallaPorIndumentaria tallaPorIndumentaria, DocumentoAcreedor documentoAcreedor, double monto, int cantidad, char estatus) {
       this.id = id;
