...
public class IngresoFormaPago  implements java.io.Serializable {
    ...
    public IngresoFormaPago(IngresoFormaPagoId id, Ingreso ingreso, double monto, char estatus) {
        this.id = id;
        this.ingreso = ingreso;
        this.monto = monto;
        this.estatus = estatus;
    }
    public IngresoFormaPago(IngresoFormaPagoId id, Ingreso ingreso, DatoBasico datoBasicoByCodigoFormaPago, DatoBasico datoBasicoByCodigoTarjeta, DatoBasico datoBasicoByCodigoBanco, double monto, char estatus, String numeroDocumentoPago) {
       this.id = id;
       this.ingreso = ingreso;
...
@ManyToOne(fetch=FetchType.LAZY)
    ...
    public void setDatoBasicoByCodigoFormaPago(DatoBasico datoBasicoByCodigoFormaPago) {
        this.datoBasicoByCodigoFormaPago = datoBasicoByCodigoFormaPago;
    }
...
@ManyToOne(fetch=FetchType.LAZY)
    ...
    public void setDatoBasicoByCodigoTarjeta(DatoBasico datoBasicoByCodigoTarjeta) {
        this.datoBasicoByCodigoTarjeta = datoBasicoByCodigoTarjeta;
    }
