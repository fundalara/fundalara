 ...
 * de archivos. Recibe dos parametros: -archivo: byte[] o AMedia. -orientacion:
 * 'vertical'(por defecto), 'horizontal'
 * 
 * @author Robert A
 * @author German L
...
public class CntrlVisorDocumento extends GenericForwardComposer {
	...
	public void onCreate$winVisorDocumento() {
		...
		String orientacion = (String) formulario.getVariable("orientacion", false);
		...
		if (file instanceof byte[]) {
			...
			if (archivo != null) {
				...
				amedia = new AMedia("archivo." + formato[1], formato[1], mime, mediais);
