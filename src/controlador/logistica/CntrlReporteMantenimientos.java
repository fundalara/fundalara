 ...
 * fechas generar el reporte de mantenimientos por instalaciones
 * 
 * @author Reinaldo L.
 * 
 * */
public class CntrlReporteMantenimientos extends GenericForwardComposer {
	...
	public void onClick$btnImprimir() throws SQLException, JRException, IOException, ParseException {
		...
		String rutaReporte = Sessions.getCurrent().getWebApp().getRealPath("/WEB-INF/Reportes/Logistica/ReporteMantenimientos.jrxml");
		JasperReport report = JasperCompileManager.compileReport(rutaReporte);
		JasperPrint print = JasperFillManager.fillReport(report, parameters, con);

		// Exporta el informe a PDF
		String rutaExportar = Sessions.getCurrent().getWebApp().getRealPath("/WEB-INF/Reportes/Logistica/ReporteMantenimientos.pdf");
