...
import dao.logistica.InstalacionDAO;
...
public class ServicioInstalacion implements IServicioInstalacion {
	...
	public void setInstalacionDAO(InstalacionDAO instalacionDAO) {
	...
	public List<Instalacion> listarInstalacion() {
		List<Instalacion> a = instalacionDAO.listar(new Instalacion());
